...
// import { ACTOR_ADMINISTRATIVE } from "../../constants/ActorConstant";

const OrganizerManagement = ({ children, routeName, urlRole }) => {
    ...
    useEffect(() => {
        ...
        // if (user.role.includes(ACTOR_ADMINISTRATIVE)) {
            ...
            {layout === "dashboard" && (
                <>
                    <Sidenav
                        ...
                        routes={isAdministrative ? OrganizerRoutes : OrganizerRoutes.filter(item => item.key !== "event-in-semester" && item.key !== "hire-design-list")}
