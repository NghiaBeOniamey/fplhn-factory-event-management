...
import { AdminHCategoryApi } from "./AdminHCategoryManagementApi";
import "./style.css";
import {
  faList,
  faMagnifyingGlass,
...
export default function CategoryList() {
  ...
  const loadDataCategory = (page) => {
    AdminHCategoryApi.categoryList(page, searchName)
      .then((response) => {
  ...
  const updateCategory = (id) => {
    ...
    AdminHCategoryApi.updateCategory(id, obj)
      .then((response) => {
  ...
  const deleteCategory = (id) => {
    AdminHCategoryApi.deleteCategory(id)
      .then((response) => {
  ...
  const detailCategory = (id) => {
    AdminHCategoryApi.detailCategory(id)
      .then((response) => {
  ...
  const postCategory = () => {
    ...
    AdminHCategoryApi.addCategory(obj)
      .then((response) => {
