...
const CommentSection = (props) => {
  ...
  useEffect(() => {
    AdminHEventDetailApi.getCommentByIdEvent(props.value, currentPage).then(
      (res) => {
  ...
  const handleSend = (idComment, commentIndex) => {
    ...
    AdminHEventDetailApi.postReplyComment({
      eventId: props.value,
  ...
  const handleDelete = (commentID) => {
    AdminHEventDetailApi.deleteComment({
      commentId: commentID,
      // userId: "",
    })
      .then((res) => {
  ...
  const handlePostComment = () => {
    ...
    AdminHEventDetailApi.postComment({
      eventId: props.value,
      comment: comment,
    }).then(
      (res) => {
