...
import { AdminHSemesterApi } from "./AdminHSemesterApi";
...
export default function Semester() {
    ...
    const loadListTable = (currentPage) => {
        AdminHSemesterApi.fetchAll(currentPage, searchName).then((response) => {
