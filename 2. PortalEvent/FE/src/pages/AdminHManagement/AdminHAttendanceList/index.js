...
import AdminHExportExcel from "./AdminHExportExcel";

const {Option} = Select;

export default function ADHAttendanceList() {
    ...
    const handleResetForm = () => {
        ...
        AdminHAttendanceListApi.fetchAttendanceList({
            page: currentPage - 1,
            size: pageSize,
            idEvent: id
        })
    ...
    const handleSearch = () => {
        ...
        // //console.log(obj)
        AdminHAttendanceListApi.fetchAttendanceList(obj)
            .then((response) => {
                // //console.log(response.data.data.data);
                setListAttendance(response.data.data.data);
                setTotalPages(response.data.data.totalPages);
            ...
            <div className="rounded-lg shadow-md w-full bg-white p-8">
                ...
                <div style={{marginTop: 20}}>
                    <Card
                        ...
                        extra={<AdminHExportExcel eventId={id}/>}
                        bordered={false}
                    >
                        <Table
