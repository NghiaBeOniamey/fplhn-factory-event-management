...
import AdminHRegistrationExportExcel from './AdminHRegistrationExportExcel'
import {AdminHRegistrationListApi} from './AdminHRegistrationListApi'

export default function ADHRegistrationList() {
    ...
    const handleResetForm = () => {
        ...
        AdminHRegistrationListApi.fetchAll({
            page: currentPage - 1,
            size: pageSize,
            idEvent: id
        })
    ...
    const handleSearch = () => {
        ...
        // //console.log(obj)
        AdminHRegistrationListApi.fetchAll(obj)
            .then((response) => {
                // //console.log(response.data.data.data);
                setListRegistration(response.data.data.data);
                setTotalPages(response.data.data.totalPages);
            ...
            <div className="rounded-lg shadow-md w-full bg-white p-8">
                ...
                <div style={{marginTop: 20}}>
                    <Card
                        ...
                        extra={<>
                            <AdminHRegistrationExportExcel eventId={id}/>
