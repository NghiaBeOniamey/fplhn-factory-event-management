...
import { ADEventWaitingApprovalApi } from "./ADRegistrationListApi";
import moment from "moment/moment";
// import ExportCSV from './ExportExcel';
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faEye, faFilter } from "@fortawesome/free-solid-svg-icons";
import "./index.css";
import APStatisticsEventApi from "../../AdminHManagement/APStatisticsEvent/APStatisticsEventApi";
import {
    AdminHEventWaitingApprovalApi
} from "../../AdminHManagement/AdminHEventWaitingApproval/AdminHRegistrationListApi";
...
export default function EventWaitingApproval() {
    ...
    const loadCategory = () => {
        ADEventWaitingApprovalApi.fetchListCategory()
            .then((response) => {
    ...
    const loadDepartment = async () => {
        try {
            const response = await ADEventWaitingApprovalApi.fetchListEventDepartment();
    ...
    const loadListEvent = () => {
        ADEventWaitingApprovalApi.fetchListEventWaiting({
            page: currentPage - 1,
            size: 5,
            name: null,
            eventGroup: null,
    ...
    return (
        <>
            ...
            {/*        <Select className="me-2" showSearch optionFilterProp="children"*/}
            {/*                style={{width: '100%'}}*/}
            {/*                defaultValue={parentMajorList[0]?.code}*/}
            {/*                onChange={(value) => {*/}
