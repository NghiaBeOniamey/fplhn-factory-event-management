...
const APSEParticipantInEventByCategory = ({ idSemester, idMajor }) => {
    ...
    useEffect(() => {
        if (idSemester !== "" && idMajor !== "" && category !== "") {
            //console.log(idSemester , idMajor, category);
            APStatisticsEventApi.getParticipantInEventByCategory(idSemester, idMajor, category).then(
                (res) => {
                    setListLabel([])
