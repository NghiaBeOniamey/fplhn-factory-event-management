...
import ADExportExcel from "./ADExportExcel";
...
export default function AttendanceList() {
    ...
    const handleResetForm = () => {
        ...
        ADAttendanceListApi.fetchAttendanceList({
            page: currentPage - 1,
            size: pageSize,
            idEvent: id
        })
    ...
    const handleSearch = () => {
        ...
        // //console.log(obj)
        ADAttendanceListApi.fetchAttendanceList(obj)
            .then((response) => {
                // //console.log(response.data.data.data);
                setListAttendance(response.data.data.data);
                setTotalPages(response.data.data.totalPages);
            ...
            <div className="rounded-lg shadow-md w-full bg-white p-8">
                ...
                <div style={{marginTop: 20}}>
                    <Card
                        ...
                        extra={<ADExportExcel eventId={id}/>}
                        bordered={false}
                    >
                        <Table
