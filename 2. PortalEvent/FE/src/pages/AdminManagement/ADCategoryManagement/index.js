...
import { ADCategoryApi } from "./ADCategoryManagementApi";
import ".//style.css";
import {
  faList,
  faMagnifyingGlass,
...
export default function CategoryList() {
  ...
  const loadDataCategory = (page) => {
    ADCategoryApi.categoryList(page, searchName)
      .then((response) => {
  ...
  const updateCategory = (id) => {
    ...
    ADCategoryApi.updateCategory(id, obj)
      .then((response) => {
  ...
  const deleteCategory = (id) => {
    ADCategoryApi.deleteCategory(id)
      .then((response) => {
  ...
  const detailCategory = (id) => {
    ADCategoryApi.detailCategory(id)
      .then((response) => {
