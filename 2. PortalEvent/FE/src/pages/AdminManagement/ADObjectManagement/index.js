...
import { ADObjectApi } from "./ADObjectManagementApi";
import ".//style.css";
...
export default function ObjectList() {
  ...
  const loadDataObject = (page) => {
    ADObjectApi.objectList(page, searchName)
      .then((response) => {
  ...
  const updateObject = (id) => {
    ...
    ADObjectApi.updateObject(id, obj)
      .then((response) => {
