...
import {Button, Card, Col, DatePicker, Form, Input, Pagination, Row, Select, Space, Table} from "antd";
...
export default function AttendanceList() {
    ...
    const handleSearch = () => {
        ...
        // //console.log(obj)
        APAttendanceListApi.fetchAttendanceList(obj)
            .then((response) => {
                // //console.log(response.data.data.data);
                setListAttendance(response.data.data.data);
                setTotalPages(response.data.data.totalPages);
            ...
            <div className="rounded-lg shadow-md w-full bg-white p-8">
                ...
                <div style={{marginTop: 20}}>
                    <Card
                        ...
                        extra={<APExportExcel eventId={id}/>}
                        bordered={false}
                    >
                        <Table
