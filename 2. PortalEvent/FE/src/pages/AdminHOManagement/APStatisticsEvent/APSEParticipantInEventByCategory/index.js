...
const APSEParticipantInEventByCategory = ({ idSemester, idCampus, idDepartment }) => {
    ...
    useEffect(() => {
        if (idSemester !== "" && idCampus !== "" && idDepartment !== "" && category !== "") {
            //console.log(idSemester, idCampus, idDepartment, category);
            APStatisticsEventApi.getParticipantInEventByCategory(idSemester, idCampus, idDepartment, category).then(
                (res) => {
                    setListLabel([])
    ...
    }, [idSemester, idCampus, idDepartment, category]);
