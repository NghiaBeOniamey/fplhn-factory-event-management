...
import { ADMIN_OBJECT_MANAGEMENT } from "../../../constants/DisplayName";
import { AdminHOObjectManagementApi } from "./AdminHOObjectManagementApi";
...
export default function ObjectList() {
  ...
  const loadDataObject = (page) => {
    AdminHOObjectManagementApi.objectList(page, searchName)
      .then((response) => {
  ...
  //Search Object
  const searchObject = (page,searchName) => {
    AdminHOObjectManagementApi.objectList(page,searchName)
      .then((response) => {
        setListObject(response.data.data);
        setCurrentPage(0);
  ...
  const updateObject = (id) => {
    ...
    AdminHOObjectManagementApi.updateObject(id, obj)
      .then((response) => {
  ...
  const deleteObject = (id) => {
    AdminHOObjectManagementApi.deleteObject(id)
      .then((response) => {
  ...
  const detailObject = (id) => {
    AdminHOObjectManagementApi.detailObject(id)
      .then((response) => {
  ...
  const postObject = () => {
    ...
    AdminHOObjectManagementApi.addObject(obj)
      .then((response) => {
        ...
        <div className="row">
          ...
          <div className="style-button">
            <Button
              type="primary"
              onClick={() => {
                searchObject(currentPage,searchName);
              }}
            >
          ...
          <div className="button-object">
            ...
            <ShowHistoryModal displayName={ADMIN_OBJECT_MANAGEMENT} />
          </div>
        </div>
        <Modal
