...
import "./index.css";
import { AdminHOEventApprovedApi } from "./AdminHOEventApprovedApi";
...
export default function EventApproved() {
    ...
    //     AdminHOEventApprovedApi.fetchAllParentMajor().then(response => {
    ...
    const handleOk = () => {
        AdminHOEventApprovedApi.handleExport(selectedMajor);
    ...
    const loadListEvent = (currentPage) => {
        AdminHOEventApprovedApi.fetchAll({
            page: currentPage - 1,
            name: null,
            categoryId: null,
            startTime: null,
    ...
    const loadCategory = () => {
        AdminHOEventApprovedApi.fetchListCategory()
            .then((response) => {
    ...
    return (
        <>
                ...
                <div style={{ marginTop: 20 }}>
                    <Card
                        ...
                        extra={<>
                            ...
                            <Button type='primary' style={{ backgroundColor: "#1E6E43" }} onClick={() => AdminHOEventApprovedApi.handleExportEvent()}><FileExcelOutlined /> Export Excel Events</Button>
                        </>}
                        bordered={false}
                    >
                        <Table
            ...
            >
                <hr />
                <br />
                {/*<Button onClick={() => AdminHOEventApprovedApi.handleExportEvent()}>Export Excel</Button>*/}
