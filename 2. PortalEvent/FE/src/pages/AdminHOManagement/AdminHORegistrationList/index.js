...
import AdminHORegistrationExportExcel from "./AdminHORegistrationExportExcel";
import ShowHistoryModal from "../../../components/ShowHistoryModal";
import {ORGANIZER_REGISTRATION_LIST} from "../../../constants/DisplayName";

export default function AdminHORegistrationList() {
    ...
    const handleResetForm = () => {
        ...
        AdminHORegistrationListApi.fetchAll({
            page: currentPage - 1,
            size: pageSize,
            idEvent: id
        })
    ...
    const handleSearch = () => {
        ...
        // //console.log(obj)
        AdminHORegistrationListApi.fetchAll(obj)
            .then((response) => {
                // //console.log(response.data.data.data);
                setListRegistration(response.data.data.data);
                setTotalPages(response.data.data.totalPages);
            ...
            <div className="rounded-lg shadow-md w-full bg-white p-8">
                ...
                <div style={{marginTop: 20}}>
                    <Card
                        ...
                        extra={<>
                            <AdminHORegistrationExportExcel eventId={id}/>
