...
import { AdminHOAttendanceListApi } from "./AdminHOAttendanceListApi";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faFilter, faStar } from "@fortawesome/free-solid-svg-icons";
import AdminHOExportExcel from "./AdminHOExportExcel";

const { Option } = Select;

export default function AdminHOAttendanceList() {
    ...
    const handleResetForm = () => {
        ...
        AdminHOAttendanceListApi.fetchAttendanceList({
            page: currentPage - 1,
            size: pageSize,
            idEvent: id
        })
    ...
    const handleSearch = () => {
        ...
        // //console.log(obj)
        AdminHOAttendanceListApi.fetchAttendanceList(obj)
            .then((response) => {
                // //console.log(response.data.data.data);
                setListAttendance(response.data.data.data);
                setTotalPages(response.data.data.totalPages);
            ...
            <div className="rounded-lg shadow-md w-full bg-white p-8">
                ...
                <div style={{marginTop: 20}}>
                    <Card
                        ...
                        extra={<AdminHOExportExcel eventId={id}/>}
                        bordered={false}
                    >
                        <Table
