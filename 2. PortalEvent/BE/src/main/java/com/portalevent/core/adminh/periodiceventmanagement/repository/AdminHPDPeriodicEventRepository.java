package com.portalevent.core.adminh.periodiceventmanagement.repository;
 ...
 */
public interface AdminHPDPeriodicEventRepository extends PeriodicEventRepository {
    ...
    @Query(value = """
            ...
            ORDER BY a.last_modified_date DESC
            """, nativeQuery = true)
    Page<AdminHPDPeriodicEventResponse> getPage(Pageable pageable, @Param("req") AdminHPDFindPeriodEventRequest req);
    ...
    @Query(value = """
            ...
            ORDER BY a.last_modified_date DESC
            """, nativeQuery = true)
    Page<AdminHPDPeriodicEventResponse> getPageEventWaitApprover(Pageable pageable, @Param("req") AdminHPDFindPeriodEventRequest req, TokenFindRequest request);
