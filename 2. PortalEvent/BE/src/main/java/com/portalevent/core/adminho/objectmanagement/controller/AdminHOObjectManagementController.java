package com.portalevent.core.adminho.objectmanagement.controller;
...
@RestController
@RequestMapping(Constants.UrlPath.URL_API_ADMIN_HO_OBJECT_MANAGEMENT)

public class AdminHOObjectManagementController {

    private final AdminHOObjectManagementService objectApproverService;

    public AdminHOObjectManagementController(AdminHOObjectManagementService objectApproverService) {
        this.objectApproverService = objectApproverService;
    }

    //Lấy ra list object
    @GetMapping("/list-object-approved")
    public PageableObject getListObject(final AdminHOObjectManagementListRequest request) {
    ...
    public ResponseObject postObject(@RequestBody AdminHOObjectManagementCreatRequest request) {
    ...
    public ResponseObject updateObject(@PathVariable("id") String id, @RequestBody AdminHOObjectManagementCreatRequest request) {
