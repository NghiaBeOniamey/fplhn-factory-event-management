package com.portalevent.core.adminh.categorymanagement.service.impl;
...
import com.portalevent.core.adminh.categorymanagement.repository.AdminHCategoryManagementRepository;
...
@Service
@Validated
public class AdminHCategoryManagementServiceImpl implements AdminHCategoryManagementService {

    private final LoggerUtil loggerUtil;

    private final AdminHCategoryManagementRepository apCategoryReponsitory;

    public AdminHCategoryManagementServiceImpl(LoggerUtil loggerUtil, AdminHCategoryManagementRepository apCategoryReponsitory) {
    ...
    @Transactional
    @Override
    public PageableObject<AdminHCategoryManagementListReponse> getListCategory(AdminHCategoryManagementListRequest request) {
        request.setName(request.getName().replaceAll("\\s+", " "));
        return new PageableObject<AdminHCategoryManagementListReponse>(apCategoryReponsitory.getCategoryList(PageRequest.of(request.getPage(),
     ...
     */
    @Override
    public Category postCategory(@Valid AdminHCategoryManagementCreateRequest request) {
        request.setName(request.getName().replaceAll("\\s+", " "));
        List<AdminHCategoryManagementListReponse> categoryListReponse = apCategoryReponsitory.getCategoryByName(request.getName());
     ...
     */
    @Override
    public Category updateCategory(String id, @Valid AdminHCategoryManagementCreateRequest request) {
        request.setName(request.getName().replaceAll("\\s+", " "));
