...
import com.portalevent.core.admin.eventdetailmanagement.model.response.AdminerCommentResponse;
...
@Repository
public interface AdminerCommentRepository extends CommentRepository {
    ...
    @Query(value = """
            ...
            """, nativeQuery = true)
    List<AdminerCommentResponse> getReplyCommentByReplyIdAndEventId(@Param("eventId") String eventId, @Param("listId") List<String> listReplyId);
