...
public class AdminerExcelParticipantLecturerGenerator {
    ...
    public AdminerExcelParticipantLecturerGenerator() {
    ...
    public void writeData(List<AdminerParticipantLecturerResponse> participants) {
        int rowCount = 1;
        for (AdminerParticipantLecturerResponse participantLecturerResponse : participants) {
