...
public interface AewaParticipantLecturerRepository extends ParticipantRepository {
...
//    List<AdpParticipantLecturerResponse> findAllParticipantLecturer();
    ...
    @Query(value = """
            ...
            AND
                s.name = :semesterName
            """, nativeQuery = true)
    List<AewaParticipantLecturerExcelResponse>
    findAllParticipantLecturerWithSubjectCode(String subjectCode, String trainingFacilityCode, String semesterName);
