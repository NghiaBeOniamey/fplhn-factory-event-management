package com.portalevent.core.adminh.registrationlistmanagement.repository;
...
@Repository
public interface AdminHRParticipantRepository extends ParticipantRepository {
    @Query(value = """
            SELECT a.id as id,
            ...
            ORDER BY a.created_date DESC
            """, nativeQuery = true)
    Page<AdminHEventParticipantResponse> getListResgistration(Pageable pageable, @Param("req") AdminHEventParticipantRequest req, TokenFindRequest request);
