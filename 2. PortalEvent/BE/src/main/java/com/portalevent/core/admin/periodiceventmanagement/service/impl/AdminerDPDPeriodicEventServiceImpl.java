package com.portalevent.core.admin.periodiceventmanagement.service.impl;
...
import com.portalevent.core.admin.periodiceventmanagement.repository.AdminerDPDPeriodicEventRepository;
...
@Service
@Validated
public class AdminerDPDPeriodicEventServiceImpl implements AdminerDPDPeriodicEventService {

    private final AdminerDPDPeriodicEventRepository apdPeriodicEventRepository;
    ...
    public AdminerDPDPeriodicEventServiceImpl(AdminerDPDPeriodicEventRepository apdPeriodicEventRepository, @Qualifier(PeriodicEventObjectRepository.NAME) PeriodicEventObjectRepository periodicEventObjectRepository, @Qualifier(PeriodicEventMajorRepository.NAME) PeriodicEventMajorRepository periodicEventMajorRepository, PortalEventsSession session) {
    ...
    @Override
    public PageableObject<AdminerDPDPeriodicEventResponse> getPage(final AdminerDPDFindPeriodEventRequest request) {
        Pageable pageable = PageRequest.of(request.getPage(), request.getSize());
        return new PageableObject<>(apdPeriodicEventRepository.getPage(pageable, request));
    }

    @Override
    public PageableObject<AdminerDPDPeriodicEventResponse> getPageEventWaitApprover(AdminerDPDFindPeriodEventRequest request) {
        Pageable pageable = PageRequest.of(request.getPage(), request.getSize());
    ...
    @Override
    public PeriodicEvent create(@Valid AdminerDPDCreatePeriodicEventRequest request) {
    ...
    @Override
    public PeriodicEvent update(@Valid AdminerDPDUpdatePeriodicEventRequest request) {
    ...
    @Override
    public AdminerDPDDetailPeriodicEventCustom detail(String id) {
        Optional<PeriodicEvent> periodicEventFind = apdPeriodicEventRepository.findById(id);
        if (!periodicEventFind.isPresent()) {
            throw new RestApiException(Message.PERIODIC_EVENT_NOT_EXISTS);
        }
        AdminerDPDDetailPeriodicEventCustom apdDetailPeriodicEventCustom = new AdminerDPDDetailPeriodicEventCustom();
