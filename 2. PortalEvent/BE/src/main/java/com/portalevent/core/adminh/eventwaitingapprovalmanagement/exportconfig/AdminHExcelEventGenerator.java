...
public class AdminHExcelEventGenerator {

    @Getter
    private XSSFWorkbook workbook;
    private XSSFSheet sheet;

    public AdminHExcelEventGenerator() {
    ...
    public void writeData(List<AdminHeeEventExcelResponse> events) throws ParseException {
        int rowCount = 1;
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("HH:mm dd/MM/yyyy");
        for (AdminHeeEventExcelResponse event : events) {
...
//            row.createCell(10).setCellValue(diffTimeFormatted);
            ...
            row.createCell(11).setCellValue(event.getNumberOfStudents());
