...
@Repository
public interface AdminHOewCommentRepository extends CommentRepository {
    ...
    @Query(value = """
            ...
            """, nativeQuery = true)
    List<AdminHOedCommentResponse> getReplyCommentByReplyIdAndEventId(@Param("eventId") String eventId, @Param("listId") List<String> listReplyId);
