...
public class ExcelParticipantGenerator {

    @Getter
    private XSSFWorkbook workbook;
    private XSSFSheet sheet;

    public ExcelParticipantGenerator() {
    ...
    public void writeData(List<AewaParticipantExcelResponse> participants) {
        int rowCount = 1;

        for (AewaParticipantExcelResponse participant : participants) {
