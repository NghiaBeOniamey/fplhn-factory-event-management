...
import com.portalevent.core.approver.eventattendancelist.exportconfig.ExcelAttendanceGenerator;
...
public class AealEventAttendanceController {
    ...
    @PostMapping
    public ResponseObject getAllAttendance(@RequestBody AealEventAttendanceSearchRequest request) {
