package com.portalevent.core.adminh.eventattendancelist.controller;

import com.portalevent.core.adminh.eventattendancelist.exportconfig.ExcelAttendanceGenerator;
...
@RestController
@RequestMapping(Constants.UrlPath.URL_API_ADMIN_H_ATTENDANCE_LIST)

public class AminHEventAttendanceController {
    @Autowired
    private AdminHEventAttendanceService service;

    @PostMapping
    public ResponseObject getAllAttendance(@RequestBody AdminHEventAttendanceSearchRequest request) {
