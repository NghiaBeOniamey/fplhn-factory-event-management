package com.portalevent.core.admin.categorymanagement.repository;
...
@Repository
public interface AdminCategoryManagementRepository extends CategoryRepository {
    ...
    @Query(value = """
            ...
            countQuery = """
                    ...
                    """,
            nativeQuery = true)
    Page<AdminCategoryManagementListReponse> getCategoryList(Pageable pageable, AdminCategoryManagementListRequest req);
    ...
    @Query(value = """
            ...
            """, nativeQuery = true)
    List<AdminCategoryManagementListReponse> getCategoryByName(@Param("name") String categoryName);
