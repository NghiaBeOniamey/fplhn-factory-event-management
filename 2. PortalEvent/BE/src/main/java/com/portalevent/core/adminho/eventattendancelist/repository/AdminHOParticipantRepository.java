package com.portalevent.core.adminho.eventattendancelist.repository;
...
@Repository
public interface AdminHOParticipantRepository extends ParticipantRepository {
    ...
    """, nativeQuery = true)
    List<AdminHOEventAttendanceListResponse> getAttendanceListByIdEvent(@Param("idEvent") String id);
    ...
    @Query(value = """
            ...
            ORDER BY a.created_date DESC
            """, nativeQuery = true)
    Page<AdminHOEventAttendanceListResponse> getAllAttendance(Pageable pageable, @Param("req") AdminHOEventAttendanceSearchRequest req, TokenFindRequest request);
