...
public class AdminHOExcelParticipantGenerator {
    ...
    public AdminHOExcelParticipantGenerator() {
    ...
    public void writeData(List<AdminHOpParticipantResponse> participants) {
        int rowCount = 1;

        for (AdminHOpParticipantResponse participant : participants) {
