package com.portalevent.core.adminh.periodiceventmanagement.service.impl;
...
import com.portalevent.core.adminh.periodiceventmanagement.repository.AdminHPDPeriodicEventRepository;
...
@Service
@Validated
public class AdminHPDPeriodicEventServiceImpl implements AdminHPDPeriodicEventService {

    private final AdminHPDPeriodicEventRepository apdPeriodicEventRepository;
    ...
    @Override
    public PageableObject<AdminHPDPeriodicEventResponse> getPage(final AdminHPDFindPeriodEventRequest request) {
        Pageable pageable = PageRequest.of(request.getPage(), request.getSize());
        return new PageableObject<>(apdPeriodicEventRepository.getPage(pageable, request));
    }

    @Override
    public PageableObject<AdminHPDPeriodicEventResponse> getPageEventWaitApprover(AdminHPDFindPeriodEventRequest request) {
        Pageable pageable = PageRequest.of(request.getPage(), request.getSize());
    ...
    @Override
    public PeriodicEvent create(@Valid AdminHPDCreatePeriodicEventRequest request) {
    ...
    @Override
    public PeriodicEvent update(@Valid AdminHPDUpdatePeriodicEventRequest request) {
    ...
    @Override
    public AdminHPDDetailPeriodicEventCustom detail(String id) {
        Optional<PeriodicEvent> periodicEventFind = apdPeriodicEventRepository.findById(id);
        if (!periodicEventFind.isPresent()) {
            throw new RestApiException(Message.PERIODIC_EVENT_NOT_EXISTS);
        }
        AdminHPDDetailPeriodicEventCustom apdDetailPeriodicEventCustom = new AdminHPDDetailPeriodicEventCustom();
