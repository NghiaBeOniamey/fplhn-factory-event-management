package com.portalevent.core.adminho.periodiceventmanagement.repository;
 ...
 */
public interface AdminHOPDPeriodicEventRepository extends PeriodicEventRepository {
    ...
    @Query(value = """
            ...
            ORDER BY a.last_modified_date DESC
            """, nativeQuery = true)
    Page<AdminHOPDPeriodicEventResponse> getPage(Pageable pageable, @Param("req") AdminHOPDFindPeriodEventRequest req);
    ...
    @Query(value = """
            ...
            ORDER BY a.last_modified_date DESC
            """, nativeQuery = true)
    Page<AdminHOPDPeriodicEventResponse> getPageEventWaitApprover(Pageable pageable, @Param("req") AdminHOPDFindPeriodEventRequest req, TokenFindRequest request);
