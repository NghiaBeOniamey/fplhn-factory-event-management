package com.portalevent.core.adminh.objectmanagement.controller;
...
@RestController
@RequestMapping(Constants.UrlPath.URL_API_ADMIN_H_OBJECT_MANAGEMENT)

public class AdminHObjectManagementController {

    private final AdminHObjectManagementService objectApproverService;

    public AdminHObjectManagementController(AdminHObjectManagementService objectApproverService) {
        this.objectApproverService = objectApproverService;
    }

    //Lấy ra list object
    @GetMapping("/list-object-approved")
    public PageableObject getListObject(final AdminHObjectManagementListRequest request) {
    ...
    public ResponseObject postObject(@RequestBody AdminHObjectManagementCreatRequest request) {
    ...
    public ResponseObject updateObject(@PathVariable("id") String id, @RequestBody AdminHObjectManagementCreatRequest request) {
