...
public interface OalParticipantRepository extends ParticipantRepository {
    ...
    @Query(value = """
            ...
            ORDER BY a.created_date DESC
            """, nativeQuery = true)
    Page<OalAttendanceResponse> getAllAttendance(Pageable pageable, @Param("req") OalFindAttendanceRequest req, TokenFindRequest request);
    ...
    @Query(value = """
            ...
            ORDER BY a.created_date DESC 
            """, nativeQuery = true)
    Integer countAllSearch(@Param("req") OalFindAttendanceRequest req, TokenFindRequest request);
