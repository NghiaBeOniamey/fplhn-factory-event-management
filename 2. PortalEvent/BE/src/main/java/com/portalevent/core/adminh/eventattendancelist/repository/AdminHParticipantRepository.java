package com.portalevent.core.adminh.eventattendancelist.repository;
...
@Repository
public interface AdminHParticipantRepository extends ParticipantRepository {
    ...
    @Query(value = """
            ...
            """, nativeQuery = true)
    List<AdminHEventAttendanceListResponse> getAttendanceListByIdEvent(@Param("idEvent") String id);
    ...
    @Query(value = """
            ...
            ORDER BY a.created_date DESC
            """, nativeQuery = true)
    Page<AdminHEventAttendanceListResponse> getAllAttendance(Pageable pageable, @Param("req") AdminHEventAttendanceSearchRequest req, TokenFindRequest request);
