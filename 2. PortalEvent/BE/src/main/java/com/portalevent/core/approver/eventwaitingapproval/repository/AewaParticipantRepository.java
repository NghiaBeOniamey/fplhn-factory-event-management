...
public interface AewaParticipantRepository extends ParticipantRepository {
...
//    List<AdpParticipantResponse> findAllParticipant();
    ...
    @Query(value = """
            ...
            AND
                s.name = :semesterName
            """, nativeQuery = true)
    List<AewaParticipantExcelResponse>
    findAllParticipantWithSubjectCode(String subjectCode, String trainingFacilityCode, String semesterName);
