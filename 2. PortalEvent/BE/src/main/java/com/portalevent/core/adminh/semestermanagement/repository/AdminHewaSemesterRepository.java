package com.portalevent.core.adminh.semestermanagement.repository;
...
@Repository
public interface AdminHewaSemesterRepository extends SemesterRepository {
    @Query(value = """
            ...
            WHERE (:searchName IS NULL OR s.name LIKE %:searchName%)
            """, nativeQuery = true)
    Page<AdminHewaSemesterResponse> getList(Pageable pageable, String searchName);
    ...
    @Query(value = """
            ...
            """, nativeQuery = true)
    List<AdminHewaNameSemesterResponse> findNameSemester(@Param("nameSemester") String nameSemester);
    ...
    @Query(value = """
            ...
            """, nativeQuery = true)
    List<AdminHewaIdSemesterInEventResponse> findIdSemester(@Param("idSemester") String idSemester);
