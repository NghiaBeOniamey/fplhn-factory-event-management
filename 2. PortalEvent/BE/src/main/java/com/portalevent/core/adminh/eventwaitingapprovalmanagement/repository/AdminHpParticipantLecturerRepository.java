...
public interface AdminHpParticipantLecturerRepository extends ParticipantRepository {
...
//    List<AdpParticipantLecturerResponse> findAllParticipantLecturer();
    ...
    @Query(value = """
            ...
            AND
                e.event_type IN(1, 2)
            """, nativeQuery = true)
    List<AdminHpParticipantLecturerResponse> findAllParticipantLecturerWithSubjectCode(String subjectCode);
