package com.portalevent.core.approver.registrationlist.exportconfig;
...
public class ExcelRegistrationGenerator {
    ...
    public void writeData(List<ArlRegistrationResponse> responseList) throws ParseException {
        int rowCount = 1;
        for (ArlRegistrationResponse response : responseList) {
