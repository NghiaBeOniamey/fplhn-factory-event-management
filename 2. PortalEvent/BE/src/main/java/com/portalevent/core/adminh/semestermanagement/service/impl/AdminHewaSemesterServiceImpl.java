package com.portalevent.core.adminh.semestermanagement.service.impl;

import com.portalevent.core.adminh.semestermanagement.model.request.AdminHSemesterRequest;
import com.portalevent.core.adminh.semestermanagement.model.respone.AdminHewaIdSemesterInEventResponse;
import com.portalevent.core.adminh.semestermanagement.model.respone.AdminHewaNameSemesterResponse;
import com.portalevent.core.adminh.semestermanagement.model.respone.AdminHewaSemesterResponse;
import com.portalevent.core.adminh.semestermanagement.repository.AdminHewaSemesterRepository;
...
@Service
@Validated
public class AdminHewaSemesterServiceImpl implements AdminHewaSemesterService {

    private final AdminHewaSemesterRepository repository;

    private final LoggerUtil loggerUtil;

    private final PortalEventsSession portalEventsSession;

    public AdminHewaSemesterServiceImpl(AdminHewaSemesterRepository repository, LoggerUtil loggerUtil, PortalEventsSession portalEventsSession) {
    ...
    @Override
    public PageableObject<AdminHewaSemesterResponse> getListSemester(Integer page, String searchName) {
    ...
    private void validationSemester(AdminHSemesterRequest request, String id) {
...
//        );
    ...
    @Override
    public Semester add(AdminHSemesterRequest request) {
        request.setName(request.getName().replaceAll("\\s+", " "));
        List<AdminHewaNameSemesterResponse> findName = repository.findNameSemester(request.getName());
        if (!findName.isEmpty()) {
...
//        Semester s = semester.request(new Semester());
    ...
    @Override
    public Semester update(AdminHSemesterRequest request, String id) {
        request.setName(request.getName().replaceAll("\\s+", " "));
...
//            se.setUserCode(portalEventsSession.getCurrentUserCode()); // Người cập nhật học kỳ
    ...
    public boolean remove(String id) {
        Optional<Semester> findById = repository.findById(id);
        List<AdminHewaIdSemesterInEventResponse> findId = repository.findIdSemester(id);
