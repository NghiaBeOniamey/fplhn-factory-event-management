...
@Repository
public interface AdminHOedAgendaItemRepository extends AgendaItemRepository {
    ...
    """, countQuery = """
        ...
        where a.event_id = :idevent
    """, nativeQuery = true)
    List<AdminHOedAgendaItemsDetailResponse> getListAgendaItemByEventId(@Param("idevent") String idEvent);
