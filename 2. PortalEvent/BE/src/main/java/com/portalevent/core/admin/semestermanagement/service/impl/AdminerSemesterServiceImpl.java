package com.portalevent.core.admin.semestermanagement.service.impl;
...
import com.portalevent.core.admin.semestermanagement.repository.AdminerSSemesterRepository;
...
@Service
@Validated
public class AdminerSemesterServiceImpl implements AdminerSemesterService {

    private final AdminerSSemesterRepository repository;
    ...
    public AdminerSemesterServiceImpl(AdminerSSemesterRepository repository, LoggerUtil loggerUtil, PortalEventsSession portalEventsSession) {
    ...
    @Override
    public PageableObject<AdminerSemesterResponse> getListSemester(Integer page, String searchName) {
    ...
    private void validationSemester(AdminerSemesterRequest request, String id) {
...
//        );
    ...
    @Override
    public Semester add(AdminerSemesterRequest request) {
        request.setName(request.getName().replaceAll("\\s+", " "));
        List<AdminerNameSemesterResponse> findName = repository.findNameSemester(request.getName());
        if (!findName.isEmpty()) {
...
//        Semester s = semester.request(new Semester());
    ...
    @Override
    public Semester update(AdminerSemesterRequest request, String id) {
        request.setName(request.getName().replaceAll("\\s+", " "));
...
//            se.setUserCode(portalEventsSession.getCurrentUserCode()); // Người cập nhật học kỳ
    ...
    public boolean remove(String id) {
        Optional<Semester> findById = repository.findById(id);
        List<AdminerIdSemesterInEventResponse> findId = repository.findIdSemester(id);
