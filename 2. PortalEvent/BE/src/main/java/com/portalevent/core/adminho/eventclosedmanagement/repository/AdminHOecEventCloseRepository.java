...
@Repository
public interface AdminHOecEventCloseRepository extends EventRepository {
    ...
    @Query(value = """
            ...
            """, countQuery = """
            	...
            	GROUP BY e.id ORDER BY e.last_modified_date DESC
            """, nativeQuery = true)
    Page<AdminHOecEventCloseResponse> getAllEventClose(Pageable pageable, @Param("req") AdminHOecEventCloseRequest req, TokenFindRequest request);
