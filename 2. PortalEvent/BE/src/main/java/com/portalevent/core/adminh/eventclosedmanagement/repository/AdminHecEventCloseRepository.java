...
@Repository
public interface AdminHecEventCloseRepository extends EventRepository {
    ...
    @Query(value = """
            ...
            """, countQuery = """
            	...
            	GROUP BY e.id ORDER BY e.last_modified_date DESC
            """, nativeQuery = true)
    Page<AdminHecEventCloseResponse> getAllEventClose(Pageable pageable, @Param("req") AdminHecEventCloseRequest req, TokenFindRequest request);
